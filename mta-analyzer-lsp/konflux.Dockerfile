...
COPY --from=builder /workspace/analyzer-lsp/konveyor-analyzer /usr/local/bin/konveyor-analyzer
COPY --from=builder /workspace/analyzer-lsp/konveyor-analyzer-dep /usr/local/bin/konveyor-analyzer-dep
COPY --from=builder /workspace/analyzer-lsp/external-providers/generic-external-provider/generic-external-provider /usr/local/bin/generic-external-provider
